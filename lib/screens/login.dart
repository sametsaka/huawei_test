...
import 'package:huawei_test/models/user.dart';
import 'package:huawei_test/screens/payment_entry.dart';
import 'package:huawei_test/screens/register.dart';
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    'Cüzdanı',
                    style: TextStyle(color: Colors.black, fontSize: 65.0),
                  ),
                  TextFormField(
                  ...
                  SizedBox(
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        ...
                        Future<UserModel> usermodel = dbHelper.getUser(
